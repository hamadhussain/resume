...
import { InfinitySpin,Spinner,MutatingDots,Rings,Circles,ThreeCircles } from  'react-loader-spinner'
import Portfolio from './Lips/page'
import F from "./Components/FrontPage/page";
export default function Home() {
  ...
  return (
    <>
{Loader && (<div className="w-screen h-screen flex items-center justify-center fixed top-0 left-0 right-0 bottom-0 z-50 bg-bgPrimary backgr bg-black" >
